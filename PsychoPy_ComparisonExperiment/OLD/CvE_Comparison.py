...
expName = u'CvE_Comparison'  # from the Builder filename that created this script
...
GreatJobText = visual.TextStim(win=win, name='GreatJobText',
    text=u'Great job! You are ready for the next activity.\n\nPlease let the experimenter know.\n\n',
    font=u'Arial',
...
instructions = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions(u'CvE_CompInstructions.xlsx'),
...
trials = data.TrialHandler(nReps=5, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'CvE_CompStimuli.xlsx'),
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trialComponents = [stimLeft, stimRight, key_resp_stim]
